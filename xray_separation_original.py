...
image_data = Image.open(
    r"./aligned_data/small_data/woman_praying_aligned.tiff"
...
image_data = Image.open(
    r"./aligned_data/small_data/manuscript.tiff"
...
image_data = Image.open(
    r"./aligned_data/small_data/aligned_xray.bmp"
...
imsave('x1_pre.jpg', to_uint8(x1_pre))
imsave('x2_pre.jpg', to_uint8(x2_pre))