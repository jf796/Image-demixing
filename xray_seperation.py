...
iteration_number = 20  # small for testing, change to 400 for final results
...
image_data = Image.open(
    r"C:\Users\foxy2\OneDrive - Imperial College London\Software\Data\aligned_woman_praying.tiff"
)
rgb1 = np.asarray(image_data, dtype="float32")
image_data = Image.open(
    r"C:\Users\foxy2\OneDrive - Imperial College London\Software\Data\aligned_manuscript.tiff"
)
rgb2 = np.asarray(image_data, dtype="float32")
image_data = Image.open(
    r"C:\Users\foxy2\OneDrive - Imperial College London\Software\Data\contrasty_image.bmp"
)
...
autoencoder.compile(
    optimizer=Adam, loss=["mse", "mse", "mse", "mse"], loss_weights=[1, 1, 4, 6]
)
autoencoder.fit(
    [g1_cube, g2_cube, x_cube],
    [g1_cube, g2_cube, x_cube, x_cube],
